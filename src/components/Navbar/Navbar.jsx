            ...
            <span className="navbar-item">
              <div className="menu-item">
                <Link href="#" className="buttom12" onClick={() => handleLinkClick("FUECHY")}>
                  FUECHY{" "}
                  <img className="hola" src="/flecha.svg" alt="Descripción del SVG" width="16" height="16" />
                </Link>
  ...
  <div className="modal-container">
    <div className="modal">
      <div className="submenu">
        ...
        <Link href="#" className={`navbar-link ${selectedLink === "FUECHY" ? "selected" : ""}`} onClick={() => handleLinkClick("FUECHY")}>FUECHY</Link>
