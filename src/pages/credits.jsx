    ...
    <div className="menu1bolt">
      ...
      <div className="credits-container">
        ...
        <div className="section">
          ...
          <p className="credtuser">Geronimo Bustos</p>
        </div>
        <div className="section">
        ...
        <div className="section">
          ...
          <p className="credtuser">
            Luis Jorge Chisaba Nivia, Pedro Antonio Chisaba Rico, José Antonio
            Chisaba Rico, Victor Alfonso Chisaba Bayona, Cleotilde Nagles de
            Rozo, Nancy Patricia Rozo Nagles, Yaneth Duarte Benavides, Julia
            Ospina Pacheco, Milena Ospina, Fernanda Casas Pérez, Leonardo
            Quintero López, Flor María Nivia, Juan Diego Bonilla, Noralba Duarte
        ...
        <div className="section">
          ...
          <p className="credtuser">
            Mususu-Neuque, Nivia, Yopasa, Cabiativa, Chisaba y Caita
          </p>
        </div>
      </div>
    </div>
